...
(function ($) {
    ...
    $.fn.editable.defaults = {
        ...
        formTemplate:'<form class="form-inline" autocomplete="off">' + 
                       ...
                       '&nbsp;<button type="submit" class="btn-xs btn-primary"><i class="glyphicon glyphicon-pencil"></i></button>&nbsp;<button type="button" class="btn-xs editable-cancel"><i class="glyphicon glyphicon-remove"></i></button>' + 
